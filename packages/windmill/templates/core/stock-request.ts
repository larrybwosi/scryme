...
export async function main(
  ...
  const { organizationId, requestId, requestNumber, requestedBy, totalCost } = data;

  console.log(`[StockRequest] Processing ${requestNumber} for ${requestedBy}: Total ${totalCost}`);
