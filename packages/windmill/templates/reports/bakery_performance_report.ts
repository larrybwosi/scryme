...
export async function main(data: {
  ...
  console.log(
    `Generating bakery performance report for organization: ${organizationId} since ${lastWeek.toISOString()}`,
  );
  ...
  const reportData = {
    ...
    wastePercentage:
      totalProduced > 0 ? ((totalWaste / totalProduced) * 100).toFixed(1) : "0",
