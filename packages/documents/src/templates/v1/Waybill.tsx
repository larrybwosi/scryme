...
const getThermalStyles = (primaryColor = '#2563eb') => StyleSheet.create({
  page: {
    padding: 12,
    fontSize: 10,
    fontFamily: 'Helvetica',
  ...
  <Page size="A4" style={styles.page}>
    ...
    <View style={styles.header}>
      ...
      <View style={styles.docInfo}>
        ...
        <Text style={styles.docMeta}>DATE: {format(new Date(data.date), 'MMM dd, yyyy HH:mm')}</Text>
        <Text style={styles.docMeta}>ID: {data.id.slice(-8).toUpperCase()}</Text>
      </View>
    </View>
    ...
    <View style={styles.grid}>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.cardBody}>
          ...
          <Text style={styles.addressText}>{formatAddress(data.sender.address)}</Text>
          {data.sender.phone && (
      ...
      <View style={styles.card}>
        ...
        <View style={styles.cardBody}>
          ...
          <Text style={styles.addressText}>{formatAddress(data.recipient.address)}</Text>
    ...
    <View style={styles.footer}>
      <View style={styles.qrArea}>
        {data.qrCodeUrl && <Image src={data.qrCodeUrl} style={styles.qrImage} />}
...
const ThermalWaybill = ({ data }: { data: WaybillData }) => {
  ...
  <Page size={[226, 800]} style={thermalStyles.page}>
    ...
    <View style={thermalStyles.section}>
      ...
      <Text style={thermalStyles.recipientAddress}>{formatAddress(data.recipient.address)}</Text>
      {data.recipient.phone && (
    ...
    {data.recipient.notes && (
      <View style={thermalStyles.section}>
        ...
        <Text style={thermalStyles.recipientAddress}>{data.recipient.notes}</Text>
      </View>
    )}
