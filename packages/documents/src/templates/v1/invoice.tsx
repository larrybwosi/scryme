...
export const InvoicePDF = ({
  ...
  const formatCurrency = (amount: number | undefined) => {
    if (typeof amount !== "number" || isNaN(amount))
      return `${data.currencySymbol || ""}0.00`;
      ...
      <Page size="A4" style={styles.page}>
              ...
              <View style={{ flexDirection: "row", marginBottom: 2 }}>
                ...
                <Text
                  style={[
                    ...
                    {
                      color: data.status === "PAID" ? "#059669" : "#dc2626",
                      fontWeight: "bold",
                    },
                  ]}
                >
        ...
        <View style={styles.table}>
          <View style={styles.tableHeader}>
            ...
            <Text style={[styles.tableHeaderCol, styles.colPrice]}>
              Unit Price
            </Text>
            <Text style={[styles.tableHeaderCol, styles.colAmount]}>
              Amount
            </Text>
          </View>
        ...
        <View style={styles.footer} fixed>
          ...
          {(qrCode || data.qrCode) && (
            <Image style={styles.footerQRCode} src={qrCode || data.qrCode} />
          )}
        </View>
      </Page>
    </Document>
