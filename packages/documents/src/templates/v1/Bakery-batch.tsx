...
const getStyles = (primaryColor = "#0f172a") =>
  StyleSheet.create({
    page: {
      padding: 30,
      fontSize: 10,
...
const BatchProductionForm: React.FC<BatchProductionFormProps> = ({
  batchId,
  branding,
}) => {
  ...
  const formId =
    batchId ||
    `BATCH-${new Date().getFullYear()}-${Math.floor(Math.random() * 10000)}`;
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View style={styles.headerLeft}>
            ...
            <Text style={styles.subtitle}>
              Manufacturing & Quality Control Record
            </Text>
          </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <View style={styles.col}>
              <Text style={styles.label}>
                Recipe ID <Text style={styles.required}>*</Text>
              </Text>
              <View style={styles.inputBox} />
            </View>
            <View style={styles.colLast}>
              {/* Merged Unit Field */}
              <Text style={styles.label}>
                Unit / UoM <Text style={styles.required}>*</Text>
              </Text>
              <View style={styles.inputBox} />
            </View>
          </View>
          ...
          <View style={styles.row}>
            <View style={styles.col}>
              <Text style={styles.label}>
                Planned Quantity <Text style={styles.required}>*</Text>
              </Text>
              <View style={styles.inputBox} />
            </View>
            <View style={styles.col}>
        ...
        <View style={styles.section}>
          <View style={styles.sectionHeader}>
            <Text style={styles.sectionTitle}>
              2. Actual Yield & Quality Analysis
            </Text>
          </View>
          ...
          <View style={styles.row}>
            <View style={styles.col}>
              ...
              <Text style={styles.label}>
                Actual Quantity (Good) <Text style={styles.required}>*</Text>
              </Text>
          ...
          <View style={styles.row}>
            <View style={styles.colLast}>
              ...
              <View style={styles.textAreaBox}>
                <Text style={{ color: "#cbd5e1", fontSize: 8 }}>
                  Describe why wastage occurred (e.g. burnt, contamination,
                  dropped)...
                </Text>
              </View>
            </View>
        ...
        <View style={[styles.section, { flex: 1 }]}>
          ...
          <View
            style={[styles.textAreaBox, { height: "100%", minHeight: 60 }]}
          />
        </View>
