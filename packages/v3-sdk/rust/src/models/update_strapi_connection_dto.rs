...
pub struct UpdateStrapiConnectionDto {
    /// Friendly display name, e.g. 'Main Storefront'
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    /// Strapi v4 base URL, e.g. https://cms.example.com
    #[serde(rename = "strapiUrl", skip_serializing_if = "Option::is_none")]
    pub strapi_url: Option<String>,
...
impl UpdateStrapiConnectionDto {
    pub fn new() -> UpdateStrapiConnectionDto {
