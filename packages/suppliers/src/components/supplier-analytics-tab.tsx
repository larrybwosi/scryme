...
export const SupplierAnalyticsTab: React.FC<SupplierAnalyticsTabProps> = ({
  analytics,
  isLoading,
}) => {
    ...
    <div className="grid gap-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {Math.round(
                analytics.leadTimeTrend.reduce(
                  (acc, curr) => acc + curr.days,
                  0,
                ) / (analytics.leadTimeTrend.length || 1),
              )}{" "}
              Days
            </div>
            <p className="text-xs text-muted-foreground mt-1 flex items-center">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {analytics.orderConsistency.reduce(
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Distribution of spend across product categories
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-[300px] w-full">
