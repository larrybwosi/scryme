...
export const ROLE_TEMPLATES = [
  // Executive Level
  {
    ...
    name: "Owner",
    description:
      "Complete system access with full control over all modules and settings",
    category: "executive",
  ...
  },
  {
    ...
    description:
      "Executive oversight with access to all reports, analytics, and strategic decision-making data",
    category: "executive",
    permissions: [
  ...
  // Administrative
  {
    ...
    description:
      "Full administrative access to manage users, roles, and system configuration",
    category: "management",
    permissions: [
  ...
  },
  {
    ...
    description:
      "Oversee daily operations including sales, inventory, and team management",
    category: "management",
    permissions: [
  ...
  // Logistics & Delivery
  {
    ...
    description:
      "Oversee delivery operations, fleet management, and driver coordination",
    category: "logistics",
    permissions: [
  ...
  },
  {
    ...
    name: "HR Assistant",
    description:
      "Support HR operations including attendance tracking and record maintenance",
    category: "hr",
    permissions: [
      createPermission(
  ...
  // Manufacturing & Production
  {
    ...
    description:
      "Oversee manufacturing operations, batches, and production planning",
    category: "operations",
    permissions: [
      createPermission(
  ...
  },
  {
    ...
    description:
      "Update production batches and view manufacturing instructions",
    category: "operations",
    permissions: [
      createPermission(
        RESOURCES.MANUFACTURING,
  ...
  // Technical & IT
  {
    ...
    description:
      "Manage system integrations, API keys, and technical configurations",
    category: "technical",
    permissions: [
  ...
  },
  {
    ...
    name: "Read-Only User",
    description:
      "View-only access across most modules without modification rights",
    category: "custom",
    permissions: [
      createPermission(RESOURCES.PRODUCT, PERMISSION_ACTIONS.VIEW, undefined),
      createPermission(RESOURCES.SALE, PERMISSION_ACTIONS.VIEW, undefined),
