...
-- AlterTable
ALTER TABLE "staff_shift" ADD COLUMN IF NOT EXISTS "departmentId" TEXT, ADD COLUMN IF NOT EXISTS "roleTags" TEXT[] DEFAULT ARRAY[]::TEXT[];

-- CreateTable
CREATE TABLE IF NOT EXISTS "shift_trade_request" (
    "id" TEXT NOT NULL,
...
-- CreateIndex
CREATE INDEX IF NOT EXISTS "shift_trade_request_organizationId_status_idx" ON "shift_trade_request"("organizationId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "shift_trade_request_requesterMemberId_idx" ON "shift_trade_request"("requesterMemberId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "shift_trade_request_targetMemberId_idx" ON "shift_trade_request"("targetMemberId");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "staff_task_organizationId_status_idx" ON "staff_task"("organizationId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "staff_task_memberId_status_idx" ON "staff_task"("memberId", "status");

-- CreateIndex
CREATE INDEX IF NOT EXISTS "staff_task_shiftId_idx" ON "staff_task"("shiftId");

-- AddForeignKey
DO $$ BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'shift_trade_request_organizationId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'shift_trade_request_requesterMemberId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'shift_trade_request_targetMemberId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'shift_trade_request_shiftId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'shift_trade_request_offeredShiftId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'staff_task_organizationId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'staff_task_memberId_fkey') THEN
    ...
    END IF;
    IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'staff_task_shiftId_fkey') THEN
