...
const TYPE_OPTIONS = ["All", "B2B", "B2C"]; // Adjusted based on common usage in nextgen fields
...
export function CustomersView() {
  ...
  const handleDelete = async (id: string) => {
    if (
      ...
      global.confirm("Are you sure you want to delete this customer?")
    ) {
                        ...
                        <div className="flex items-center justify-end gap-1">
                          ...
                          >
                            <button
                              ...
                              className="px-2.5 py-1.5 text-[11.5px] font-medium bg-primary/5 text-primary rounded-md hover:bg-primary/10 transition-colors"
                            >
                              Edit
                            </button>
                            <SheetContent className="sm:max-w-[440px] overflow-y-auto">
