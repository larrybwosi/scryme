        ...
        <div className="grid grid-cols-2 gap-4">
            ...
            <Popover>
              <PopoverTrigger asChild>
                ...
                >
                  ...
                  {editForm.dueDate ? (
                    format(new Date(editForm.dueDate), "PPP")
                  ) : (
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(val) =>
                setEditForm((f) => ({ ...f, priority: val as any }))
              }
            >
          ...
          <div>
            ...
            <Select
              value={editForm.type}
              onValueChange={(val) =>
                setEditForm((f) => ({ ...f, type: val as any }))
              }
            >
              <SelectTrigger className="w-full h-9 bg-background">
          ...
          <div className="col-span-2 flex items-center justify-between py-1 bg-muted/10 px-3 rounded-lg border border-border">
            <label className="flex items-center gap-2 cursor-pointer group">
              <div className="relative flex items-center">
                <input
                  ...
                  onChange={(e) =>
                    setEditForm((f) => ({ ...f, isRecurring: e.target.checked }))
                  }
                  className="sr-only"
                />
                <div
            ...
            {editForm.isRecurring && (
              <Select
                ...
                onValueChange={(val) =>
                  setEditForm((f) => ({ ...f, recurringInterval: val }))
                }
              >
    ...
    <div>
      ...
      {filtered.length === 0 ? (
        ...
        <div className="flex flex-col gap-3">
          {filtered.map((f) => (
            <FollowUpCard key={f.id} followUp={f} onComplete={handleComplete} onEdit={handleEdit} members={members} />
          ))}
        </div>
      )}
    </div>
