  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-6 py-4 border-b border-border bg-card shrink-0">
        ...
        <span className="text-[12.5px] font-semibold text-foreground">{deal.data.name}</span>
      </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-[320px] shrink-0 border-r border-border overflow-y-auto p-6 custom-scrollbar">
           <div className="space-y-6">
              ...
              <div className="pt-4 border-t border-border space-y-4">
                 <div className="text-xs font-bold text-muted-foreground uppercase tracking-wider">Associations</div>
                 ...
                 {associatedCompany && (
                    <div className="flex items-start gap-3">
                       ...
                       <div className="flex-1 min-w-0">
                          <div className="text-[13px] font-semibold truncate">{associatedCompany.name}</div>
                 ...
                 {associatedContact && (
                    <div className="flex items-start gap-3">
                       ...
                       <div className="flex-1 min-w-0">
                          <div className="text-[13px] font-semibold truncate">{associatedContact.name}</div>
                 ...
                 {!associatedCompany && !associatedContact && (
                    <div className="text-sm text-muted-foreground italic">No associations</div>
                 )}
              </div>
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
          <DetailTabs activeTab={tab} customerId={deal.id} counts={counts} availableTabs={availableTabs} />
