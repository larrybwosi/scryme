...
export class FavoritesController {
  ...
  async addFavorite(@v2Context() ctx: V2ApiContext, @Param('productId') productId: string) {
  ...
  @RequirePermission('customer:write:own')
  async removeFavorite(@v2Context() ctx: V2ApiContext, @Param('productId') productId: string) {
  ...
  @RequirePermission('customer:read:own')
  async isFavorite(@v2Context() ctx: V2ApiContext, @Param('productId') productId: string) {
