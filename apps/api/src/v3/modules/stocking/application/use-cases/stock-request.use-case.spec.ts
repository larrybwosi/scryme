...
describe('StockRequestUseCase', () => {
  ...
  it('should fulfill from transfer', async () => {
    ...
    await stockRequestUseCase.fulfillFromTransfer(mockOrgId, mockMemberId, mockRequestId, dto);

    expect(mockTx.stockTransfer.create).toHaveBeenCalledWith(expect.objectContaining({
      data: expect.objectContaining({
        fromLocationId: 'loc-from',
        toLocationId: 'loc-to',
    ...
    expect(mockTx.stockRequestItem.updateMany).toHaveBeenCalledWith(expect.objectContaining({
  ...
  it('should fulfill from purchase', async () => {
    ...
    await stockRequestUseCase.fulfillFromPurchase(mockOrgId, mockMemberId, mockRequestId, dto);
