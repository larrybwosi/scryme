import { Controller, Post, Get, Patch, Body, Headers, UnauthorizedException, UseGuards } from '@nestjs/common';
...
export class StandalonePosController {
  ...
  @Post('activate')
  @ApiOperation({ summary: 'Redeem a setup key to activate a standalone POS device' })
  ...
  @ApiHeader({ name: 'X-Standalone-Key', description: 'The long-lived standalone device key' })
