...
@Global()
@Module({
  imports: [forwardRef(() => V3AuthModule), PrismaModule, RedisModule, forwardRef(() => InventoryModule)],
  ...
  exports: [GetProductsUseCase, CreateProductUseCase, PricingResolverService, PricingManagementService],
})
