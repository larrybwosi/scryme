...
@Module({
  imports: [PrismaModule, RedisModule, forwardRef(() => V3AuthModule), CrmModule],
  ...
  exports: [GetCustomersUseCase, RegisterCustomerUseCase, UpdateCustomerUseCase, BusinessAccountService, ICustomerRepository],
})
