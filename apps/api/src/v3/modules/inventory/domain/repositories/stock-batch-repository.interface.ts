...
export interface IStockBatchRepository {
  ...
  findByBatchNumber(batchNumber: string, organizationId: string): Promise<StockBatchEntity | null>;
  ...
  update(id: string, data: Partial<StockBatchEntity>): Promise<StockBatchEntity>;
}
