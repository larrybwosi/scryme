  ...
  const [transactions, setTransactions] = useState([
    {
      id: "1",
      date: "2023-10-01",
      description: "M-PESA B2C - MP123456",
      amount: -5000,
      status: "MATCHED",
      match: "Expense EXP-001",
    },
    {
      id: "2",
      date: "2023-10-02",
      description: "M-PESA C2B - QS987654",
      amount: 12500,
      status: "UNMATCHED",
      match: null,
    },
    {
      id: "3",
      date: "2023-10-03",
      description: "Bank Transfer DEP-111",
      amount: 50000,
      status: "UNMATCHED",
      match: null,
    },
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription>
                Match bank statement lines with internal records.
              </CardDescription>
            </div>
            <Button>
              ...
              {transactions.map(tx => (
                <TableRow key={tx.id}>
                  ...
                  <TableCell className="text-sm text-muted-foreground italic">
                    {tx.match ||
                      (tx.id === "2" ? "Order ORD-1234 (KES 12,500)" : "-")}
                  </TableCell>
