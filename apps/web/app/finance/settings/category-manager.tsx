  ...
  return (
    <div className="h-full flex flex-col">
      <div className="p-6 border-b border-zinc-100 flex items-center justify-between bg-zinc-50/50">
        <div>
          <h3 className="text-base font-bold text-zinc-900">Expense Categories</h3>
          <p className="text-xs text-zinc-500 mt-0.5">Categorize and map expenses to General Ledger</p>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="space-y-4">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      <span className="text-[10px] font-mono text-[#34A853] font-bold">{cat.code || 'NO-CODE'}</span>
                      <span className="text-[10px] text-zinc-300">•</span>
                      <div className="flex items-center gap-1">
                        <Lock className="w-2.5 h-2.5 text-zinc-400" />
                        <span className="text-[10px] text-zinc-400 font-medium">GL: {cat.glCode || 'Unmapped'}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="text-right hidden md:block">
                    <p className="text-[10px] text-zinc-400 font-bold uppercase">Approvals</p>
          ...
          <div className="mt-8 p-4 rounded-xl bg-blue-50 border border-blue-100 flex items-start gap-3">
            ...
            <div>
              <p className="text-xs font-bold text-blue-900">General Ledger Integration</p>
              <p className="text-[11px] text-blue-700 mt-0.5 leading-relaxed">
                GL codes are used to automatically export financial data to your accounting software. Ensure these codes match your Chart of Accounts.
              </p>
            </div>
          </div>
        </div>
