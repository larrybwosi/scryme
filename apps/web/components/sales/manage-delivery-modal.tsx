...
import {
  ...
  approveFulfillment, // Ensure this action is exported from your sales actions
...
export function ManageDeliveryModal({
  ...
  const [reconcileFulfillmentId, setReconcileFulfillmentId] = useState<
    string | null
  >(null);
                      ...
                      transaction.fulfillments.map((f: any) => (
                        <div
                          ...
                          <div className="flex gap-2 pt-2 border-t border-zinc-50">
                            ...
                            {/* HEAD Branch Change Fallback for Completed Statuses */}
                            {!f.isReconciled && f.status === "COMPLETED" && (
                              <Button
                                size="sm"
                                variant="outline"
                                className="h-8 text-[11px] flex-1 gap-1.5"
