...
import { ClipboardCheck, ShieldCheck, FileUp, X, FileText } from "lucide-react";
        ...
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-3">
            <Label className="text-xs font-bold uppercase tracking-wider text-zinc-500">
              Proof Documents (Physical Scans/Photos)
            </Label>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="relative">
                ...
                {dnFile && (
                  <button
                    onClick={() => setDnFile(null)}
                    className="absolute -top-2 -right-2 p-1 bg-zinc-900 text-white rounded-full shadow-lg hover:bg-zinc-800 transition-colors">
                    <X className="w-3 h-3" />
                  </button>
                )}
              </div>
