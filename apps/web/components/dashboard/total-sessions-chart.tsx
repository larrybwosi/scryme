...
interface TotalSessionsChartProps {
...
export function TotalSessionsChart({ data, value, change, periodLabel }: TotalSessionsChartProps) {
    ...
    <Card className="p-6 bg-white border-none shadow-sm h-full">
      <div className="flex justify-between items-start mb-6">
        <div className="space-y-1">
          ...
          <div className="text-[10px] text-muted-foreground">User per 2 days</div>
        </div>
