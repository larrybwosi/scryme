...
export function StaffPerformance({ stats, transactions }: { stats: any, transactions: any[] }) {
  ...
  const chartData = transactions
    ...
    .reverse()
    .map(tx => ({
      name: new Date(tx.createdAt).toLocaleDateString('en-US', { weekday: 'short' }),
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="bg-white border-none shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-gray-500">Sales Velocity</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white border-none shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-gray-500">Revenue Contribution</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(stats.monthlySalesValue)}</div>
        ...
        <Card className="bg-white border-none shadow-sm">
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium text-gray-500">Average Ticket</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-white border-none shadow-sm">
          <CardHeader>
            <CardTitle className="text-lg font-bold">Recent Sales Trend</CardTitle>
            <CardDescription>Daily revenue from last 7 transactions</CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white border-none shadow-sm">
            <CardHeader>
                ...
                <CardDescription>Detailed metrics across different categories</CardDescription>
            </CardHeader>
