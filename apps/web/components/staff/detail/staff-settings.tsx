...
export function StaffSettings({ member }: { member: any }) {
  ...
  const handleResetPassword = async () => {
    if (!confirm("Are you sure you want to reset this member's password? A random password will be generated.")) {
        return;
    }
      ...
      <div className="lg:col-span-2 space-y-6">
        <form onSubmit={handleUpdate} className="space-y-6">
          <Card className="border-none shadow-sm bg-white">
            <CardHeader>
              ...
              <CardDescription>Manage staff personal details and contact information.</CardDescription>
            </CardHeader>
          ...
          <div className="flex justify-end">
            <Button type="submit" disabled={loading} className="gap-2 bg-[#1D1D1F]">
              <Save size={16} />
        ...
        <Card className="border-none shadow-sm bg-white">
            <CardHeader>
                ...
                <CardDescription>Advanced account security settings.</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="flex items-center justify-between p-4 rounded-xl border border-red-100 bg-red-50/30">
                    <div className="space-y-1">
                        ...
                        <p className="text-xs text-gray-500">This will generate a new random password for the user.</p>
                    </div>
                    <Button
                        variant="destructive"
                        size="sm"
      ...
      <div className="space-y-6">
        <Card className="border-none shadow-sm bg-white">
          <CardHeader>
            ...
            <CardDescription>Configure POS and access credentials.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label>Card ID</Label>
              <div className="flex gap-2">
                ...
                />
                <Button variant="outline" size="icon" onClick={handleGenerateCard} type="button" title="Generate random Card ID">
                  <RefreshCcw size={16} />
                </Button>
              </div>
            </div>
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                ...
                />
                <Button variant="outline" size="icon" onClick={handleGeneratePin} type="button" title="Generate random 6-digit PIN">
                  <Key size={16} />
                </Button>
              </div>
              <p className="text-[10px] text-gray-500">
                Staff will use this PIN to log in to the POS and perform sensitive actions.
              </p>
            </div>
          </CardContent>
        </Card>
