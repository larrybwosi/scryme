...
export const ProductListItem = memo(
  ({ product, onAddToCart, onSelectProduct, pricingMode, customPriceCalculator }: ProductProps) => {
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                {product.activeIngredient && (
                  <Badge
                    variant="outline"
                    className="h-4 px-1 bg-emerald-50 text-emerald-700 border-emerald-200 text-[9px] font-bold uppercase"
                  >
                    {product.activeIngredient}
                  </Badge>
                )}
          ...
          <div className="flex items-center gap-2 mt-0.5">
            ...
            <div className="flex items-center gap-2 flex-1 min-w-0">
              ...
              {product.variants.length > 1 && (
                <span className="text-[10px] text-muted-foreground italic truncate">{currentVariant.name}</span>
              )}
            </div>
