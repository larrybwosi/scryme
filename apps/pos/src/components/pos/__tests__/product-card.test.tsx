...
describe('ProductCard Component', () => {
  ...
  it('renders product information correctly', () => {
    render(<ProductCard product={mockProduct as any} onAddToCart={vi.fn()} pricingMode="retail" />);
  ...
  it('triggers item addition on click', () => {
    ...
    render(<ProductCard product={mockProduct as any} onAddToCart={onAddToCart} pricingMode="retail" />);
