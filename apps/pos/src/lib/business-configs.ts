...
export const businessConfigs: Record<BusinessType, BusinessConfig> = {
  ...
  retail: {
    ...
    defaultCategories: ['Services', 'Clothing', 'Accessories', 'Footwear', 'Home', 'Beauty'],
    requiredFields: {
      customerName: false,
      customerPhone: true,
      customerAddress: false,
  ...
  pharmacy: {
    ...
    orderTypes: ['pickup', 'delivery'],
    defaultCategories: ['Services', 'Prescription', 'OTC Medicine', 'Vitamins', 'First Aid', 'Personal Care'],
    requiredFields: {
      customerName: true,
      customerPhone: true,
      customerAddress: false,
