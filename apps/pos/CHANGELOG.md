...
- **order creation:** updated the custom pricing ([f968ed5](https://github.com/larrybwosi/dealio-desktop/commit/f968ed5c89e2ffc52377b105f47e1fc6ef932f68))
- replace js config with json to fix CI error ([294339e](https://github.com/larrybwosi/dealio-desktop/commit/294339e7b524f50b82e6cc05e9dffa356b81af61))

### Features

- **stock acceptance:** added the stock accptance to the location with validation ([fbadb8d](https://github.com/larrybwosi/dealio-desktop/commit/fbadb8d9ce994ced7b0fd5e2bdfab5fe0243751b))
- **upload server:** file upload server for images and documents ([f7c0be3](https://github.com/larrybwosi/dealio-desktop/commit/f7c0be30bbaff90574392c1ae2efb95cdfa597b2))
