      ...
      >
        ...
        <div className="hidden lg:flex items-center gap-1 flex-1 ml-4">
            ...
            >
              <div className="col-span-8 grid grid-cols-2 gap-3">
                ...
                {modules.map((product) => (
                  <Link
                    ...
                    onClick={() => {
                      setActiveMenu(null);
                      trackEvent("nav_product_clicked", { product: product.code, href: product.href });
                    }}
                  >
                    <div
              ...
              >
                ...
                <Link
                  ...
                  onClick={() => {
                    setActiveMenu(null);
                    trackEvent("nav_view_all_products_clicked");
                  }}
                >
              ...
              {solutionLinks.map((item) => {
                ...
                return (
                  <Link
                    ...
                    onClick={() => {
                      setActiveMenu(null);
                      trackEvent("nav_solution_clicked", { name: item.name, href: item.href });
                    }}
                  >
                    <div
                      className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 mt-0.5"
              ...
              {resourceLinks.map((item) => {
                ...
                return (
                  <Link
                    ...
                    onClick={() => {
                      setActiveMenu(null);
                      trackEvent("nav_resource_clicked", { name: item.name, href: item.href });
                    }}
                  >
                    <div
                      className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 mt-0.5"
          ...
          <Link
            ...
            onClick={() => {
              setActiveMenu(null);
              trackEvent("nav_pricing_clicked");
            }}
          >
            Pricing
          </Link>
        ...
        <div className="hidden lg:flex items-center gap-3 ml-auto">
          ...
          <Link
            ...
            onClick={() => trackEvent("nav_status_clicked")}
          >
          ...
          <a
            ...
            onClick={() => {
              ...
              trackEvent("nav_signin_clicked", { destination: `${webUrl}/login` });
            }}
          >
            Sign in
          </a>
        ...
        <div className="container mx-auto px-6 flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 gap-2 pl-2 border-l" style={{ borderColor: colors.inkLine }}>
                {modules.map((m) => (
                  <Link
                    ...
                    onClick={() => {
                      setMobileOpen(false);
                      trackEvent("mobile_nav_product_clicked", { product: m.code });
                    }}
                  >
                    <span
              ...
              <div className="grid grid-cols-1 gap-2 pl-2 border-l" style={{ borderColor: colors.inkLine }}>
                {solutionLinks.map((s) => (
                  <Link
                    ...
                    onClick={() => {
                      setMobileOpen(false);
                      trackEvent("mobile_nav_solution_clicked", { name: s.name });
                    }}
                  >
                    {s.name}
                  </Link>
              ...
              <div className="grid grid-cols-1 gap-2 pl-2 border-l" style={{ borderColor: colors.inkLine }}>
                {resourceLinks.map((r) => (
                  <Link
                    ...
                    onClick={() => {
                      setMobileOpen(false);
                      trackEvent("mobile_nav_resource_clicked", { name: r.name });
                    }}
                  >
                    {r.name}
                  </Link>
          ...
          <div className="flex flex-col gap-3 pt-4 border-t" style={{ borderColor: colors.inkLine }}>
            ...
            <a
              ...
              onClick={() => {
                trackEvent("mobile_nav_signin_clicked");
                setMobileOpen(false);
              }}
            >
              Sign in
