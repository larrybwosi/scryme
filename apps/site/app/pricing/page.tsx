...
import { getPricingPageContent, getPageMetadata } from "../../lib/sanity";
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return getPageMetadata({
    pageSeo: content.seo,
    fallbackTitle: "Pricing — Simple, Transparent Plans to Scale Your Business",
    fallbackDescription: "Explore Scryme pricing plans. Scale from independent retail to enterprise multi-branch operations with our integrated POS, custom storefront websites, and advanced stock tracking.",
