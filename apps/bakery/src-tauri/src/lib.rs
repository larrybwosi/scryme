...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::start_device_setup_command,
            commands::get_locations_command,
            commands::create_pairing_session_command,
            commands::get_pairing_session_status_command,
            commands::authorize_pairing_session_command,
