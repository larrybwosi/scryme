    ...
    <div className="space-y-6 max-w-[1400px] mx-auto pb-10">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-card/40 p-4 rounded-xl border border-border/40 backdrop-blur-md">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto">
          {selectedIds.size > 0 && (
            <div className="flex items-center gap-2 animate-in fade-in slide-in-from-right-2">
              <Button
                size="sm"
                variant="outline"
                className="h-9 border-border/60 font-bold text-xs uppercase tracking-wider"
              >
                Bulk Print
              </Button>
          ...
          <Button
            variant="outline"
            className="h-10 gap-2 text-xs border-border/60 font-medium hidden sm:flex"
              ...
              {loadingBatches
                ...
                : filteredBatches.map((batch) => (
                    <TableRow
                      key={batch.id}
                      className={cn(
                        "group transition-all border-border/20",
          ...
          <div className="px-6 py-6 border-b border-border/30 bg-muted/20">
            <SheetHeader>
              <SheetTitle className="text-xl font-bold tracking-tight">
                Provision Manufacturing Order
              </SheetTitle>
              <SheetDescription className="font-medium text-muted-foreground">
                Define parameters for a new production batch.
              </SheetDescription>
            </SheetHeader>
          </div>
        ...
        <SheetContent className="w-full sm:max-w-2xl p-0 border-l border-border/50">
          <div className="px-6 py-6 border-b border-border/30 bg-muted/20">
            <SheetHeader>
              ...
              <SheetDescription className="font-medium text-muted-foreground">
                Verify output standards and record final yield.
              </SheetDescription>
            </SheetHeader>
          </div>
      ...
      <Sheet open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <SheetContent className="w-full sm:max-w-3xl p-0 border-l border-border/50">
          <div className="px-6 py-6 border-b border-border/30 bg-muted/20">
            <SheetHeader>
              <SheetTitle className="text-xl font-bold tracking-tight">
                Modify Production Run
              </SheetTitle>
              <SheetDescription className="font-medium text-muted-foreground">
                Update parameters for this active run.
              </SheetDescription>
            </SheetHeader>
          </div>
          <div className="p-6 overflow-y-auto h-[calc(100vh-8rem)]">
          ...
          <div className="bg-emerald-600 p-8 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-emerald-100 text-sm">
                Batch has been successfully authorized and committed to stock.
              </p>
            </div>
          </div>
