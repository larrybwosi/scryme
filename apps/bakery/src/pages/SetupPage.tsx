        ...
        <Card className="shadow-2xl border-0 bg-white/90 backdrop-blur-md animate-in fade-in slide-in-from-bottom-4 duration-500">
          <CardHeader className="space-y-1 text-center pb-6">
            ...
            <CardDescription className="text-gray-600">
              Enter a setup token from your dashboard to provision this device.
            </CardDescription>
          </CardHeader>
                  ...
                  {hardwareInfo ? (
                    <>
                      ...
                      <div className="flex justify-between text-xs">
                        ...
                        <span
                          className="font-mono text-amber-900 font-bold truncate ml-4"
                          title={hardwareInfo.serialNumber}
                        >
