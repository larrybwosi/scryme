...
import { loginMockUser } from "@/app/lib/actions";
        ...
        <Card className="border-zinc-800 bg-zinc-900/50 backdrop-blur-md text-zinc-100">
          ...
          <CardContent className="space-y-4 pt-2">
            <form action={handleMockLogin} className="space-y-4">
              ...
              <Button type="submit" variant="default" className="w-full font-semibold border-zinc-800 hover:bg-zinc-800 text-zinc-100 flex items-center justify-center gap-2 transition-colors">
